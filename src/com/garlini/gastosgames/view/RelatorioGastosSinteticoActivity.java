...
import com.garlini.gastosgames.report.RelatorioGastosSintetico;
...
public class RelatorioGastosSinteticoActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_relatorio_gastos_sintetico);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.relatorio_gastos_sintetico, menu);
		return true;
	}
	...
	class LoadRelatorioTask extends AsyncTask<String, Integer, String>
	{
		...
		protected String doInBackground(String... params) {
			...
			RelatorioGastosSintetico relatorio = new RelatorioGastosSintetico(getApplicationContext(), dbHandler.getReadableDatabase());
