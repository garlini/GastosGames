...
import com.garlini.gastosgames.report.RelatorioGastos;
...
public class RelatorioGastosActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_relatorio_gastos);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.relatorio_gastos, menu);
		return true;
	}
	...
	class LoadRelatorioTask extends AsyncTask<String, Integer, String>
	{
		...
		protected String doInBackground(String... params) {
			...
			RelatorioGastos relatorio = new RelatorioGastos(getApplicationContext(), dbHandler.getReadableDatabase());
